...
const PromocionApp = () => {
    ...
    return (
<div className="container-fluid fondoVerde">
    <div className="container pt-5">
        <div className="row ">
            <div className="col-md-6 text-center">
                <img src={"/images/landing_page_image-croped-5-1-1.png"} alt={"Smartphone app"}  width={320}/>
            </div>
            <div className="col-md-6 d-flex align-items-end">
                <div>
                    <h3>Descarga la App y difruta mucho mas por mucho menos</h3>
